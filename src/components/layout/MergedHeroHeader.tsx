...
const MergedHeroHeader: React.FC = () => {
  ...
  const stats = [
    { icon: Building2, value: '25+', label: t('stats.sectors'), description: t('stats.sectorsDesc') },
    { icon: Users, value: '50K+', label: t('stats.employees'), description: t('stats.employeesDesc') },
    { icon: Globe, value: '15+', label: t('stats.countries'), description: t('stats.countriesDesc') },
    { icon: Target, value: '₺500M+', label: t('stats.revenue'), description: t('stats.revenueDesc') },
  ];
