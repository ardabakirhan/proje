          ...
          {businessAreas.map((area, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-br ${area.color} opacity-30 group-hover:opacity-40 transition-opacity duration-500`}></div>
              </div>
              ...
              <div className="relative p-6">
                ...
                <div className="w-full h-24 mb-4 flex items-center justify-center">
                  <img
                    src={area.image}
                    alt={area.title}
                    className="w-20 h-20 object-contain group-hover:scale-110 transition-transform duration-300 drop-shadow-lg"
                  />
                </div>
                
                {/* Icon */}
                <div className={`w-12 h-12 bg-gradient-to-br ${area.color} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg mx-auto`}>
