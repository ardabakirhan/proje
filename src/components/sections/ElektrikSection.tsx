...
import { Zap, Shield, Cpu, ArrowRight, Battery, Lightbulb } from 'lucide-react';
...
const ElektrikSection: React.FC = () => {
  ...
  const features = [
    {
      icon: Zap,
      title: t('elektrik.features.powerSystems.title'),
      description: t('elektrik.features.powerSystems.description'),
      color: 'text-yellow-600'
    },
    {
      icon: Shield,
      title: t('elektrik.features.safety.title'),
      description: t('elektrik.features.safety.description'),
      color: 'text-green-600'
    },
    {
      icon: Cpu,
      title: t('elektrik.features.automation.title'),
      description: t('elektrik.features.automation.description'),
      color: 'text-blue-600'
    },
    {
      icon: Battery,
      title: t('elektrik.features.energyStorage.title'),
      description: t('elektrik.features.energyStorage.description'),
      color: 'text-purple-600'
    }
  ];

  return (
    <section className="section-padding bg-gradient-to-br from-yellow-50 to-blue-50">
        ...
        >
          <div className="text-center">
            ...
            <h3 className="text-3xl font-bold text-secondary-900 mb-4">
              {t('elektrik.cta.title')}
            </h3>
            
            <p className="text-xl text-secondary-600 mb-8 max-w-2xl mx-auto">
              {t('elektrik.cta.description')}
            </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="btn-primary text-lg px-8 py-4">
                {t('elektrik.cta.consultationBtn')}
              </button>
              <button className="btn-secondary text-lg px-8 py-4">
                {t('elektrik.cta.projectsBtn')}
              </button>
            </div>
