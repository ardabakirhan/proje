...
const AboutSection: React.FC = () => {
  ...
  const stats = [
    ...
    { icon: Users, value: '50K+', label: t('about.stats.employees.label'), description: t('about.stats.employees.description') },
    { icon: Globe, value: '15+', label: t('about.stats.countries.label'), description: t('about.stats.countries.description') },
    { icon: Target, value: '₺500M+', label: t('about.stats.revenue.label'), description: t('about.stats.revenue.description') },
  ];
